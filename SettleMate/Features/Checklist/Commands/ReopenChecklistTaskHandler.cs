...
public sealed class ReopenChecklistTaskHandler(
    ApplicationDbContext dbContext,
    IValidator<ReopenChecklistTaskCommand> validator)
    : IHandler<ReopenChecklistTaskCommand, Result<bool>>
{
    public async Task<Result<bool>> HandleAsync(
        ReopenChecklistTaskCommand command,
